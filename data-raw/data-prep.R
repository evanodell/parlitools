...
# British Election Study Data -----------------------------------------------------------
  ...
  names(bes_2015) <- gsub("pc", "pc_", names(bes_2015))
  names(bes_2015) <- gsub("ld", "ld_", names(bes_2015))
  names(bes_2015) <- gsub("snp", "snp_", names(bes_2015))
  names(bes_2015) <- gsub("bnp", "bnp_", names(bes_2015))
  names(bes_2015) <- gsub("ukip", "ukip_", names(bes_2015))
  names(bes_2015) <- gsub("ppcsex", "ppc_sex", names(bes_2015))
  names(bes_2015) <- gsub("ppcrace", "ppc_race", names(bes_2015))

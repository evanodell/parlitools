...
The most up-to-date documentation for the development version will always be at https://docs.evanodell.com/parlitools/. 
...
For more details see [the full documentation](https://docs.evanodell.com/parlitools/).
...
`bes_2015` - A tibble with the British Election Study 2015 Constituency Results Version 2.2. For information on all the variables in this dataset, see the [bes-2015 vignette](https://docs.evanodell.com/parlitools/articles/bes-2015.html) (Source: https://www.britishelectionstudy.com/data-object/2015-bes-constituency-results-with-census-and-candidate-data/)
...
For more details, please see the [introductory vignette](https://docs.evanodell.com/parlitools/articles/introduction.html) and [using `parlitools` with `cartogram`](https://docs.evanodell.com/parlitools/articles/using-cartograms.html).

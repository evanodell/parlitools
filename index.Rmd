...
[`mps_on_date`](https://docs.evanodell.com/parlitools/reference/mps_on_date.html) - Uses functions from `hansard` and `mnis` to create a tibble with data on all MPs from a given date, their party affiliation and their constituency.

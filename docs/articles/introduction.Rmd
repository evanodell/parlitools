...
elect2015_details <- left_join(constits, elect2015, by = c("about"= "constituency_about")) #Join constituency details to electoral results.

current_mps_colours <- left_join(current_mps, party_colour, by = "party_id") #Join to current MP data

west_hex_map <- left_join(west_hex_map, current_mps_colours, by = "gss_code") #Join colours to hexagon map

west_hex_map <- left_join(west_hex_map, elect2015_details, by = "gss_code") #Join constituency and electoral details to hexagon map
